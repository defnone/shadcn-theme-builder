...
>(({ className, showTooltip = false, tooltipContent, ...props }, ref) => {
  ...
  return (
    <SliderPrimitive.Root
      ...
      {...props}>
      <SliderPrimitive.Track className='bg-secondary relative grow overflow-hidden rounded-full data-[orientation=horizontal]:h-2 data-[orientation=vertical]:h-full data-[orientation=horizontal]:w-full data-[orientation=vertical]:w-2'>
